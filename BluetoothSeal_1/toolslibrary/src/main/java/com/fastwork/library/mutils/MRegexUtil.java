...
public class MRegexUtil {
    ...
    /**
     * 匹配手机号码的正则表达式
     * <br>支持130——139、150——159、160——169、170——179、180——189、190——199号段
     */
    public static final String PHONE_NUMBER_REGEX = "^1{1}([356789]{1}\\d{1})\\d{8}$";
    ...
    /**
     * 匹配给定的字符串是否是一个手机号码
     * 支持130——139、150——159、160——169、170——179、180——189、190——199号段
     *
     * @param string 给定的字符串
     * @return true：是
     */
    ...
    public static InputFilter inputFilter = new InputFilter() {
        Pattern emoji = Pattern.compile("[\u4e00-\u9fa5a-zA-Z\\d,，。？！（）{}@【】,.?!(){}'“”……、；《》]+$",
    ...
    //  只能输入汉字数字字母
    public static InputFilter inputFilterCharAndNumber = new InputFilter() {
