...
public class DepartSealAdapter extends BaseAdapter {

    private Context mContext;
    private List<SealModel> mList;
    public DepartSealAdapter(Context context, List<SealModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SealModel model = mList.get(position);
        if (model != null) {
